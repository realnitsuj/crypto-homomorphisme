...
Formule du produit:
    c_0^ $\times$  = c_0^(1)*c_0^(2) = 2863*3887 = 11128481 mod(65537) = 52728
    c1^ $\times$  = c_0^(1)*c_1^(2)+c_1^(1)*c_0^(2) = 2863*1234 + 1234*3887 = 3532942 + 4796558 = 8329500 mod(65537) = 6301
    c2^  $\times$ = c_1^(1)*c_1^(2) = 1234*1234 = 1522756 mod(65537) = 15405
...
m'^ $\times$  = c_0'+c_1'*s = 2596+6301=8897 mod(65537) = 8897

On utilise : $m={pipe_bas}m' \times  \delta ^{2}[pipe]={pipe_bas}8897/1024^{2}[pipe]=0$
...
Produit brut (avant relinearisation) :
Formule du produit:
    c_0^ $\times$  = c_0^(1)*c_0^(2) =  2863*3887 = 11128481 mod(68719476736) = 11128481
    c_1^ $\times$  = c_0^(1)*c_1^(2)+c_1^(1)*c_0^(2) = 2863*1234 + 1234*3887 = 3532942 + 4796558 = 8329500 mod(68719476736) = 8329500
    c_2^ $\times$ = c_1^(1)*c_1^(2) = 1234*1234 = 1522756 mod(68719476736) = 1522756
...
m'^ $\times$  = c_0'+c_1'*s = 12651237+8329500 = 20980737 mod(68719476736) = 20980737

On utilise : $m={pipe_bas}m' \times  \delta ^{2} [pipe]={pipe_bas}20980737/1024^{2}[pipe] = 20$
